    ...
    public static final List<ProductInfo> PRODUCTS = new ArrayList<ProductInfo>(){
        {
            ...
            //Pet & Beauty
            add(new ProductInfo(31, "Fish Toys Moving Fish Toy for Cat", 10.99, 2345, "pet", 10));
            add(new ProductInfo(32, "Woodbase Cat Litter 30 Litre", 13.98, 2374, "pet", 49));
            add(new ProductInfo(33, "Cat Litter 6 Inlays Tray Liners Dust", 17.00, 350, "pet", 130));
            add(new ProductInfo(34, "PetSafe Drinkwell", 11.98, 389, "pet", 50));
            add(new ProductInfo(35, "large Cat Litter Tray Toilet Box", 32.99, 1661, "pet", 79));
            add(new ProductInfo(36, "Garnier Sheet Masks Self-Care Collection", 12.18, 130, "beauty", 500));
            add(new ProductInfo(37, "Assorted Mix Lip Balm Gift Set", 11.28, 8652, "beauty", 59));
            add(new ProductInfo(38, "Reusable Makeup Remover Pads", 5.99, 9386, "beauty", 459));
            add(new ProductInfo(39, "False Eyelashes", 8.99, 46, "beauty", 390));
            add(new ProductInfo(40, "Jade Roller Gift Set", 16.95, 2890, "beauty", 308));
